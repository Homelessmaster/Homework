package FifthSeminar.views;

import FifthSeminar.models.Table;
import FifthSeminar.presenters.View;
import FifthSeminar.presenters.ViewObserver;
...
public class BookingView implements View {
    ...
    @Override
    public void showСhangeReservationTable(int reservationNo) {
        if (reservationNo > 0){
            System.out.printf("Столик успешно перезабронирован. Номер вашей брони: #%d\n", reservationNo);
        }
        else {
            System.out.println("Не удалось перезабронировать столик, повторите попытку позже.");
        }
    }
